...
export default defineNuxtConfig({
    ...
    head: {
      ...
      meta: [
        ...
        },
        {
          ...
          name: "keywords",
          content:
            "nih sparc, sparc program, stimulating peripheral activity to relieve conditions, common fund sparc, sparc, sparc initiative, sparc neuro, sparc science",
        },
        ...
        },
        {
          ...
          property: "og:image",
          content:
            "https://images.ctfassets.net/6bya4tyw8399/7r5WTb92QnHkub8RsExuc1/2ac134de2ddfd65eb6316421df7578f9/sparc-logo-primary.png",
        },
        {
        ...
        },
        {
          hid: "og:url",
          property: "og:url",
          content: process.env.ROOT_URL || "sparc.science",
        },
  ...
  turnstile: {
    siteKey:
      process.env.NUXT_PUBLIC_TURNSTILE_SITE_KEY || "0x4AAAAAAATLCwNJ5HNQWRsX",
  },
  vite: {
    define: {
      "window.global": {},
  ...
  runtimeConfig: {
    public: {
      ...
      SHOW_DATASET_SUBMISSION_FEATURE:
        process.env.SHOW_DATASET_SUBMISSION_FEATURE || "false",
      METACELL_SDS_VIEWER_URL:
        process.env.METACELL_SDS_VIEWER_URL ||
        "https://metacell.github.io/sds-viewer",
      ...
      FLATMAP_API: "https://mapcore-demo.org/current/flatmap/v3/",
  ...
  sitemap: {
    ...
    sources:
      process.env.DEPLOY_ENV === "production" ? ["/api/__sitemap__/urls"] : [],
    exclude:
  ...
  vue: {
    compilerOptions: {
      isCustomElement: (tag: string) => ["bsky-embed"].includes(tag),
    },
  },
});
